...
figlet.text("SOUIY".toUpperCase(), { font: "ANSI Shadow", horizontalLayout: "default" }, (err, data) => {
  if (err) headerBox.setContent("{center}{bold}SOUIY{/bold}{/center}");
...
safeRender();
mainMenu.focus();
addLog("Dont Forget Follow tiktok @Souiy1!!", "system");
updateWalletData();